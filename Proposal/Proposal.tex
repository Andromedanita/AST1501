...
We can then convert the Cartesian coordinates to the cylindrical coordinates, $R,z,\phi$ using equation(?):
...
We also need to have the initial velocities in cylindrical coordinates and if we have the initial coordinates in cartesian coordinates, they can easily be converted to cylindrical ones using equation (?):
